        ...
        <div class="solution__wrapper">
            <div class="solution__left">
                <div class="solution__img-1">
                    <img src="../assets/imgs/service/services-developer.jpg" alt="Solution Image">
                </div>
                <div class="solution__img-2">
                    <img src="../assets/imgs/service/content-creations.jpg" alt="Solution Image">
                </div>
            </div>
            ...
            <div class="solution__right">
                <div class="solution__img-3">
                    <img src="../assets/imgs/service/cloud.jpg" alt="Solution Image">
                </div>
            </div>
        </div>
                            ...
                            <div class="service__items-6">
                                ...
                                <div class="service__item-6 has__service_animation" id="service_1" data-secid="1">
                                    ...
                                    <div class="animation__service_page">
                                        <h2 class="service__title-6">User paths or user flows functional models</h2>
                                        <p>This is the second workshop of the UX design methodology. Given all the
                                            conclusions drawn
                                            in the personae workshop, we will project ourselves towards the production of
                                            ideal user
                                            journeys.
                                            In other words: how each persona can achieve their goal.</p>
                                        <ul>
                                ...
                                <div class="service__item-6" id="service_2" data-secid="2">
                                    ...
                                    <div class="animation__service_page">
                                        <h2 class="service__title-6">Web & Mobile Development</h2>
                                        <p>This is the second workshop of the UX design methodology. Given all the
                                            conclusions drawn
                                            in
                                            the
                                            personae workshop, we will project ourselves towards the production of ideal
                                            user journeys.
                                            In
                                            other
                                ...
                                <div class="service__item-6" id="service_3" data-secid="3">
                                    ...
                                    <div class="animation__service_page">
                                        <h2 class="service__title-6">UMotion & Branding Design</h2>
                                        <p>This is the second workshop of the UX design methodology. Given all the
                                            conclusions drawn
                                            in
                                            the
                                ...
                                <div class="service__item-6" id="service_6" data-secid="6">
                                    ...
                                    <div class="animation__service_page">
                                        <h2 class="service__title-6">Illustrations & Prototype</h2>
                                        <p>This is the second workshop of the UX design methodology. Given all the
                                            conclusions drawn
                                            in
                                            the
...
export default {
    mounted() {
        ...
        let animationServices7 = document.querySelectorAll(".animation-service-7 .service__item-7");
        gsap.set(animationServices7, {
            opacity: 0,
            x: -30
        });

        if (animationServices7.length > 0) {
            if (window.innerWidth < 1023) {
                animationServices7.forEach((item, index) => {
                    gsap.to(item, {
                        scrollTrigger: {
                            trigger: item,
                ...
                gsap.to(".animation-service-7 .service__item-7", {
                    scrollTrigger: {
                        trigger: ".animation-service-7",
                        start: "top center+=200",
                        markers: false
                    },
                    opacity: 1,
        ...
        let animationWorkflow6 = document.querySelectorAll(".animation-workflow-6 .workflow__item-4");
        if (animationWorkflow6.length > 0) {
            if (window.innerWidth < 1023) {
                animationWorkflow6.forEach((item, index) => {
                    gsap.from(item, {
                        scrollTrigger: {
                            trigger: item,
                            start: "top center+=200",
                ...
                gsap.from(".animation-workflow-6 .workflow__item-4", {
                    scrollTrigger: {
                        trigger: ".animation-workflow-6",
                        start: "top center+=200",
                        markers: false
                    },
                    opacity: 0,
