                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      <ul>
                        ...
                        <li><a href="portfolio-details-dark.html">portfolio details dark</a>
                        </li>
                      </ul>
                    </li>
                    <li>
            ...
            <div class="row">
              <div class="col-xxl-12">
                <div class="hero__about-content">
                  <h1 class="hero-title animation__word_come">
                  ...
                  <div class="hero__about-info">
                    ...
                    <div class="hero__about-text title-anim">
                      <p>
                        Think of the world's most iconica and successful
              ...
              <div class="col-xxl-12">
                <div class="hero__about-video">
                  <video loop muted autoplay playsinline>
                    <source src="../assets/video/business-video.mp4" type="video/mp4" />
                  </video>
                </div>
              </div>
            </div>
            ...
            <div class="sec-title-wrapper">
              ...
              <div class="row">
                <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-5">
                  ...
                  <h3 class="sec-title title-anim">Who we are ?</h3>
                </div>
                <div class="col-xxl-7 col-xl-7 col-lg-7 col-md-7">
                  <div class="story__text">
                    <p>

                      Fab D&C works with companies in varied domains & industry verticals. Having expertise service in
                      graphic design, Internet marketing, mobile application, development & e-commerce market place Fab
                      D&C is a full fledged IT solution provider. Having around 10 years of industry experience, the
                      founder strives to meetup to each & every client expectations by providing spectacular web and
                      mobile solution. 
                    </p>
                    <p>
                      Why look further for web design, development, marketing, mobile app creation if you
                      can have it all under 1 roof.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3">
                <div class="story__img-wrapper">
                  <img src="../assets/imgs/clients/technology.jpg" alt="Story Thumbnail" class="w-100" />
                </div>
              </div>
              <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-5">
                <div class="story__img-wrapper img-anim">
                  <img src="../assets/imgs/clients/clients.jpg" alt="Story Thumbnail" data-speed="auto" />
                </div>
              </div>
              <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4">
                <div class="story__img-wrapper">
                  <img src="../assets/imgs/designer-graphic.jpg" class="story-img-short" alt="Story Thumbnail" />
                  <img src="../assets/imgs/cloud-solution.jpeg" alt="Story Thumbnail" />
                </div>
              </div>
            </div>
          </div>
                    ...
                    <div class="swiper-wrapper">
                      <div class="swiper-slide testimonial__slide">
                        <div class="testimonial__inner-2">
                          <h2 class="testimonial__title-2">
                            Amazing digital service
                          </h2>
                          <p class="testimonial__text-2">
                            We were there right at the beginning just when the
                            concept for search engine optimisation taking
                            office and the full of internet. So wewe’ve grown
                            to employ than 50 talented specialists with
                            diverse experiences and broad skill sets of huge
                            markers.
                          </p>
            ...
            <div class="row">
              <div class="col-xxl-12">
                <div class="cta__content">
                  ...
                  <div class="btn_wrapper">
                    <a href="contact.html" class="wc-btn-primary btn-hover btn-item"><span></span>Let’s talk us
                      <i class="fa-solid fa-arrow-right"></i></a>
                  </div>
                </div>
              </div>
